...
/**
 * NOSTOS_AI Pitch Deck - Version 6.9.7
 * - Geometry: w-full applied to prevent horizontal iframe overflow.
 * - Contact: Updated to arkady.nostos@gmail.com
 * - Typography: Dynamic sizing with Michroma targeted application.
 */
        ...
        <div className="flex flex-col items-center justify-center space-y-6 lg:space-y-8 h-full text-center w-full max-w-5xl mx-auto px-2 relative z-10">
          <div className="p-5 lg:p-6 glass-panel border-emerald-500/20 rounded-[28px] w-full flex flex-col md:flex-row items-center justify-between shadow-xl gap-4">
             <div className="text-center md:text-left">
                ...
                <p className="text-white font-bold text-3xl md:text-4xl tracking-tighter italic uppercase font-nostos">March 21</p>
             </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 w-full">
             <div className="p-5 lg:p-6 glass-panel rounded-[28px] flex items-center gap-4 lg:gap-6">
                ...
                <div className="text-left">
                   <p className="text-white font-bold text-xl md:text-2xl tracking-tighter uppercase italic leading-none font-nostos">Arkady</p>
          ...
          <div className="flex flex-col items-center space-y-4 pt-4 lg:pt-6">
            <a 
              ...
              className="bg-white hover:bg-blue-50 text-black px-10 py-4 lg:px-14 lg:py-5 rounded-full font-bold text-lg md:text-xl transition-all shadow-xl uppercase tracking-widest italic hover:scale-105 active:scale-95 group inline-block decoration-transparent font-nostos"
            >
