...
/**
 * NOSTOS_AI Pitch Deck - Version 7.6 (Zero Overlap Fix)
 * - Bugfix: Resolved "Double Title Overflow" on Slide 0.
 * - Architecture: Unique centered layout for the Hero slide to prevent vertical clash.
 * - Engine: 1440x810 Mathematical Scaling Engine remains active for perfect Vercel deployment.
 * - Typography: Michroma applied strictly to NOSTOS_AI & Securing the Path Home.
 */
...
export default function App() {
  ...
  if (!isReady) return (
    <div className="h-screen w-full bg-[#020408] flex items-center justify-center">
      <div className="text-blue-500 font-mono animate-pulse tracking-[0.5em] text-xs uppercase">
        CALIBRATING_MATHEMATICAL_CANVAS_V7.6...
      </div>
    </div>
  );
  ...
  const slides = [
    {
      title: 'HERO_SLIDE', // Системный идентификатор
      subtitle: '',
      content: (
        <div className="flex flex-col items-center justify-center space-y-6 text-center h-full w-full max-w-5xl mx-auto px-4">
          ...
          <div className="relative flex-shrink-0 mb-2">
            ...
            <div className="relative p-2 rounded-[32px] glass-panel border-blue-500/30 shadow-[0_0_50px_rgba(59,130,246,0.2)] flex items-center justify-center flex-shrink-0">
              <NostosLogo className="w-36 h-36 rounded-[24px] drop-shadow-[0_0_20px_rgba(59,130,246,0.4)]" />
            </div>
          </div>

          <div className="space-y-3">
             <h2 className="text-6xl font-bold text-white tracking-tighter leading-none uppercase font-nostos">NOSTOS_AI</h2>
             <p className="text-blue-400 text-xl font-bold font-nostos uppercase tracking-[0.1em]">Securing the Path Home.</p>
          </div>

          <div className="w-24 h-[2px] bg-blue-500/50 my-6" />
          
          <div className="space-y-5">
            <div className="space-y-2 tracking-tighter">
              <p className="text-blue-500 font-mono text-sm tracking-[0.4em] mb-2 uppercase underline underline-offset-8 decoration-blue-500/40">OUR MISSION IS:</p>
            ...
            <div className="pt-5 border-t border-white/5 font-heebo" dir="rtl">
      ...
      >
        ...
        <header className="flex justify-between items-center mb-6 relative z-20 flex-shrink-0 w-full px-4">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <span className="text-[9px] text-blue-500 font-mono tracking-[0.3em] uppercase block mt-2 font-bold">Industrial_Intelligence</span>
            </div>
          </div>
        ...
        <main className="flex-1 flex flex-col justify-center items-center relative z-20 w-full overflow-hidden min-h-0">
          <div className="glass-panel rounded-[3rem] p-10 shadow-[0_0_80px_rgba(0,0,0,0.5)] h-full w-full flex flex-col relative overflow-hidden group">
            ...
            {/* FIX: Отрисовка стандартного заголовка слайда ТОЛЬКО если это не главный экран */}
            {currentSlide > 0 && (
              <div className="mb-8 text-left flex-shrink-0 relative z-10">
                ...
                <div className="flex items-center gap-5 mt-4">
                  ...
                  <p className="text-blue-400 text-sm font-bold font-mono uppercase tracking-[0.4em]">
