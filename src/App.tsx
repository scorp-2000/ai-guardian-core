...
/**
 * AI Guardian Pitch Deck - Version 4.4 (Full Viewport Optimization)
 * - Zero Horizontal/Vertical Scroll Architecture
 * - Safe-Margin Laptop Geometry (max-w-5xl)
 * - Pro-Level Industrial UI
 */
...
export default function App() {
  ...
  const slides = [
        ...
        <div className="flex flex-col items-center justify-center space-y-6 text-center h-full w-full">
          <div className="relative">
            ...
            <div className="relative p-6 rounded-3xl bg-slate-900 border border-blue-500/40 shadow-2xl">
              <Icon name="Shield" className="w-14 h-14 text-blue-400 animate-pulse" />
            </div>
          </div>
          <div className="space-y-4">
            ...
            <div className="max-w-xl mx-auto space-y-2">
              ...
              <p className="text-blue-400 font-bold text-lg font-heebo" dir="rtl">
    ...
    },
    {
      ...
      content: (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch h-full py-2 text-left">
          <div className="flex flex-col justify-between space-y-2">
             <div className="p-3 bg-red-900/10 border-l-4 border-red-500 rounded-r-2xl">
                <div className="flex justify-between items-center mb-1">
                   <h4 className="text-red-400 font-bold text-[9px] uppercase">Operational Stoppage</h4>
             ...
             <div className="p-3 bg-amber-900/10 border-l-4 border-amber-500 rounded-r-2xl">
                <div className="flex justify-between items-center mb-1">
                   <h4 className="text-amber-400 font-bold text-[9px] uppercase">Criminal Liability</h4>
             ...
             <div className="p-3 bg-blue-900/10 border-l-4 border-blue-500 rounded-r-2xl">
                <div className="flex justify-between items-center mb-1">
                   <h4 className="text-blue-400 font-bold text-[9px] uppercase">Insurance Burden</h4>
          ...
          <div className="bg-slate-900/60 p-5 rounded-[24px] border border-slate-800 flex flex-col justify-between">
             <div className="space-y-3">
                <div className="space-y-1">
                   <div className="flex justify-between text-[9px] text-slate-400 font-mono italic"><span>MANUAL AUDIT</span><span className="text-red-500 font-bold">85% RISK</span></div>
                   <div className="w-full h-1 bg-slate-800 rounded-full overflow-hidden"><div className="h-full bg-red-600 w-[85%]" /></div>
                </div>
                <div className="space-y-1">
                   <div className="flex justify-between text-[9px] text-emerald-400 font-mono italic"><span>AI GUARDIAN</span><span className="font-bold">12% RESIDUAL</span></div>
                   <div className="w-full h-2 bg-slate-800 rounded-full overflow-hidden"><div className="h-full bg-emerald-500 w-[12%] animate-pulse" /></div>
                </div>
             </div>
             <div className="mt-2 border-t border-slate-800 pt-2">
               <p className="text-sm text-slate-200 italic font-medium font-heebo leading-tight" dir="rtl">
                 "הופכים את הבטיחות מ<b>הוצאה</b> לכלי <b>ליצירת רווח</b>."
               </p>
               <p className="text-[7px] text-slate-500 font-mono mt-2 uppercase tracking-widest text-center">
    ...
    },
    {
      ...
      content: (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center h-full text-left">
           <div className="bg-black rounded-[24px] p-5 border border-blue-500/30 h-full flex flex-col justify-between relative overflow-hidden group">
              <div className="flex justify-between items-center">
                 <div className="px-2 py-0.5 bg-blue-500/20 rounded-full text-[9px] text-blue-400 font-mono border border-blue-500/30">26.4 TOPS</div>
           ...
           <div className="flex flex-col justify-center space-y-3 h-full">
              <div className="flex gap-3 items-center">
                 <div className="p-2 bg-blue-500/10 rounded-lg"><Icon name="Zap" size={20} className="text-blue-400" /></div>
                 <div>
                    <h5 className="text-white font-bold text-xs uppercase italic leading-none">NMS-free Latency</h5>
                    <p className="text-slate-400 text-[10px] mt-1 italic">Real-time hazard detection.</p>
                 </div>
              </div>
              <div className="flex gap-3 items-center">
                 <div className="p-2 bg-emerald-500/10 rounded-lg"><Icon name="Lock" size={20} className="text-emerald-400" /></div>
                 <div>
                    <h5 className="text-white font-bold text-xs uppercase italic leading-none">Data Sovereignty</h5>
                    <p className="text-slate-400 text-[10px] mt-1 italic">100% On-site processing.</p>
                 </div>
              </div>
              <div className="flex gap-3 items-center">
                 <div className="p-2 bg-purple-500/10 rounded-lg"><Icon name="Eye" size={20} className="text-purple-400" /></div>
                 <div>
                    <h5 className="text-white font-bold text-xs uppercase italic leading-none">Predictive AI</h5>
                    <p className="text-slate-400 text-[10px] mt-1 italic">Zero-Harm analytics.</p>
                 </div>
              </div>
           </div>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col items-center justify-center space-y-5 h-full text-center w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-3xl">
             ...
             <div className="p-4 bg-blue-600/10 rounded-[24px] border border-blue-500/30 flex flex-col justify-center text-right font-heebo" dir="rtl">
                <ul className="space-y-1 text-slate-200 text-xs font-medium">
  ...
  return (
    <div className="h-screen w-screen bg-[#04060b] text-slate-100 p-3 md:p-5 flex flex-col font-sans overflow-hidden relative selection:bg-blue-500/30">
      
      {/* Header - Compact height */}
      <header className="flex justify-between items-center mb-3 relative z-10 flex-shrink-0 w-full max-w-5xl mx-auto px-2">
        ...
        <div className="hidden md:flex items-center gap-4 text-[8px] font-mono text-slate-500 tracking-widest text-right uppercase">
          ...
          <div className="space-y-0.5 text-left font-bold">
            <p className="text-emerald-500">Sota_2.6_Ready</p>
            <p className="font-heebo" dir="rtl">תאימות רגולטורית</p>
          </div>
        </div>
      </header>

      {/* Main Container - Maximum Safety Geometry */}
      <main className="flex-1 flex flex-col justify-center relative z-10 w-full max-w-5xl mx-auto overflow-hidden">
        <div className="bg-slate-900/40 backdrop-blur-[40px] border border-white/5 rounded-[2.5rem] p-6 md:p-10 shadow-[0_0_100px_rgba(0,0,0,0.8)] h-full max-h-[78vh] w-full flex flex-col relative overflow-hidden group">
          ...
          <div className="mb-3 text-left flex-shrink-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-blue-400 text-sm font-black italic tracking-tight uppercase leading-none">{slides[currentSlide].subtitle}</p>
            </div>
          </div>
      ...
      <footer className="mt-3 flex justify-between items-center w-full max-w-5xl mx-auto relative z-10 flex-shrink-0 px-4">
        <div className="flex gap-2">
          {slides.map((_, idx) => (
            <div 
              key={idx} 
              className={`h-[2px] rounded-full transition-all duration-500 cursor-pointer ${idx === currentSlide ? 'w-10 bg-blue-500 shadow-blue-400/50 shadow-sm' : 'w-3 bg-slate-800'}`}
              onClick={() => setCurrentSlide(idx)}
            />
          ))}
        </div>
        <div className="flex gap-3">
          <button onClick={prev} className={`p-3 rounded-2xl bg-slate-900 border border-slate-800 text-white transition-all ${currentSlide === 0 ? 'opacity-20 cursor-not-allowed' : 'hover:border-blue-500 active:scale-90'}`}>
            <Icon name="ChevronLeft" size={20} />
          </button>
          <button onClick={next} className={`p-3 rounded-2xl bg-blue-600 text-white shadow-lg transition-all ${currentSlide === slides.length - 1 ? 'opacity-20 cursor-not-allowed' : 'hover:bg-blue-500 active:scale-90 shadow-blue-500/50'}`}>
